...
pub fn build(b: *std.Build) void {
    ...
    for ([_][]const u8{ "tests/determinism.zig", "tests/hot_reload.zig", "tests/acceptance_scenarios.zig", "tests/render_svg.zig", "tests/hud.zig", "tests/menu_acceptance.zig" }) |path| {
